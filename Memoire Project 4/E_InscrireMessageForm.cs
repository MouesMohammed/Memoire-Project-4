...
{
    public partial class E_InscrireMessageForm : Form
    {
        public E_InscrireMessageForm()
        {
            InitializeComponent();
        }
        ...
        private void InscrireAyantDroitAyantForm_Load(object sender, EventArgs e)
        {
        ...
        private void buttonNonContinuer_Click(object sender, EventArgs e)
        {
            this.Hide();
